...
if [[ $# -lt 1 ]]; then
  cat >&2 <<USAGE
Usage:
  bash run_fig1_pipeline.sh <sample_id_file> [threads] [base_dir] [out_dir] [ref_fasta]
...
Arguments:
  ...
  out_dir          Output directory for merged tables and plots (default: ./fig1_results)
